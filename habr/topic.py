...
class TMTopic(object):
    def __init__(self, topic_id, domain='habr.ru'):
        '''
        init
    ...
    def _parseTopic(self):
        ...
        post_title = doc.xpath('//h1[@class="tm-title tm-title_h1"]/span') or \
        ...
        tmp = doc.xpath('//div[@id="post-content-body"]')
...
class HabraTopic(TMTopic):
    def __init__(self, topic_id):
        super().__init__(topic_id, domain='habr.ru')
